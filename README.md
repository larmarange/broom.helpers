...
#> $ var_type      <chr> "continuous", "categorical", "categorical", "categori...
#> $ var_nlevels   <int> NA, 3, 3, 3
#> $ contrasts     <chr> NA, "contr.treatment", "contr.treatment", "contr.trea...
...
#> $ contrasts     <chr> NA, NA, NA, NA, "contr.treatment(base=3)", "contr.tre...
#> $ reference_row <lgl> NA, NA, NA, NA, NA, FALSE, FALSE, TRUE, FALSE, NA, FA...
#> $ label         <chr> "Age (in years)", "Age (in years)", "Age (in years)²"...
#> $ estimate      <dbl> NA, 20.2416394, 1.2337899, 0.4931553, NA, 1.0047885, ...
#> $ std.error     <dbl> NA, 2.3254455, 2.3512842, 2.3936657, NA, 0.4959893, 0...
#> $ statistic     <dbl> NA, 1.29340459, 0.08935144, -0.29533409, NA, 0.009631...
#> $ p.value       <dbl> NA, 0.1958712, 0.9288026, 0.7677387, NA, 0.9923154, 0...
#> $ conf.low      <dbl> NA, 0.225454425, 0.007493208, 0.004745694, NA, 0.3797...
...
#>    term  variable var_label var_class var_type var_nlevels header_row contrasts
#>    <chr> <chr>    <chr>     <chr>     <chr>          <int> <lgl>      <chr>    
#>  1 (Int~ <NA>     (Interce~ <NA>      interce~          NA NA         <NA>     
...
#> $ variable      <chr> NA, "age", "age", "age", "age", "stage", "stage", "st...
#> $ var_label     <chr> "(Intercept)", "Age in years", "Age in years", "Age i...
...
#> $ header_row    <lgl> NA, TRUE, FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, FA...
#> $ contrasts     <chr> NA, NA, NA, NA, NA, "contr.treatment(base=3)", "contr...
#> $ reference_row <lgl> NA, NA, NA, NA, NA, NA, FALSE, FALSE, TRUE, FALSE, NA...
#> $ label         <chr> "(Intercept)", "Age in years", "Age in years", "Age i...
#> $ estimate      <dbl> 0.5266376, NA, 20.2416394, 1.2337899, 0.4931553, NA, ...
#> $ std.error     <dbl> 0.4130930, NA, 2.3254455, 2.3512842, 2.3936657, NA, 0...
#> $ statistic     <dbl> -1.55229592, NA, 1.29340459, 0.08935144, -0.29533409,...
#> $ p.value       <dbl> 0.1205914, NA, 0.1958712, 0.9288026, 0.7677387, NA, 0...
```
