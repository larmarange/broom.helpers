test_that("tidy_add_contrast() works for basic models", {
  ...
  expect_equivalent(
    res$contrasts,
    c(NA, "contr.treatment", "contr.treatment", "contr.treatment",
  ...
  expect_equivalent(
    res$contrasts,
    c(NA, "contr.sum", "contr.sum", "contr.sum", "contr.helmert",
  ...
  expect_equivalent(
    res$contrasts,
    c(NA, "contr.poly", "contr.poly", "contr.poly", "contr.treatment",
