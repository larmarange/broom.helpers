...
test_that("select_helpers: tidy_plus_plus", {
  ...
  expect_equal(
    res$term,
    c(
      "grade.sd__(Intercept)", "grade.sd__stageT2", "grade.sd__stageT3",
      "grade.sd__stageT4", "grade.cor__(Intercept).stageT2",
      "grade.cor__(Intercept).stageT3", "grade.cor__(Intercept).stageT4",
      "grade.cor__stageT2.stageT3", "grade.cor__stageT2.stageT4",
      "grade.cor__stageT3.stageT4", "grade.1.sd__(Intercept)",
