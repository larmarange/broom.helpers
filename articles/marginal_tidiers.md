...
[`broom.helpers::tidy_marginal_predictions()`](https://larmarange.github.io/broom.helpers/reference/tidy_marginal_predictions.md).
...
[`broom.helpers::tidy_avg_comparisons()`](https://larmarange.github.io/broom.helpers/reference/tidy_avg_comparisons.md).
...
[^2]: More precisely, `marginaleffects::marginaleffects()` use the mean
    of continuous variables and the mode of categorical variables.
