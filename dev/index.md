# broom.helpers ![](reference/figures/broom.helpers.png)
...
`broom.helpers` is used, in particular, by
...
#> $ label          <chr> "Age (in years)", "poly(age, 3)1", "poly(age, 3)2", "po…
#> $ n_obs          <dbl> NA, 173, 173, 173, NA, 46, 50, 35, 42, NA, 63, 53, 57, …
#> $ n_event        <dbl> NA, 54, 54, 54, NA, 17, 12, 13, 12, NA, 20, 16, 18, 30,…
...
#> $ label          <chr> "(Intercept)", "Age in years", "poly(age, 3)1", "poly(a…
