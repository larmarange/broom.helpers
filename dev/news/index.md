...
- [`tidy_marginal_means()`](https://larmarange.github.io/broom.helpers/dev/reference/tidy_marginal_means.md)
...
- new function
  [`scope_tidy()`](https://larmarange.github.io/broom.helpers/dev/reference/scope_tidy.md)
...
- [`model_get_model_frame.coxph()`](https://larmarange.github.io/broom.helpers/dev/reference/model_get_model_frame.md)
...
- New method
  ...
  ([\#202](https://github.com/larmarange/broom.helpers/issues/202))
- New helper function
  [`seq_range()`](https://larmarange.github.io/broom.helpers/dev/reference/seq_range.md)
...
- Improvement of
  [`.get_package_dependencies()`](https://larmarange.github.io/broom.helpers/dev/reference/assert_package.md)
  to be more efficient. It now looks only at a single package
  description file
  ([\#178](https://github.com/larmarange/broom.helpers/issues/178))
- New function
  [`.get_all_packages_dependencies()`](https://larmarange.github.io/broom.helpers/dev/reference/assert_package.md)
  to list all dependencies of all packages
  ([\#178](https://github.com/larmarange/broom.helpers/issues/178))
- Bug fix in
  [`.get_min_version_required()`](https://larmarange.github.io/broom.helpers/dev/reference/assert_package.md)
...
- Improvement of
  [`.assert_package()`](https://larmarange.github.io/broom.helpers/dev/reference/assert_package.md)
...
- Two additional select helpers
  [`all_ran_pars()`](https://larmarange.github.io/broom.helpers/dev/reference/select_helpers.md)
  and
  [`all_ran_vals()`](https://larmarange.github.io/broom.helpers/dev/reference/select_helpers.md)
...
- New method
  [`model_get_coefficients_type.tidycrr()`](https://larmarange.github.io/broom.helpers/dev/reference/model_get_coefficients_type.md)
  ([\#128](https://github.com/larmarange/broom.helpers/issues/128))
- Updated error messaging about using
  [`broom.helpers::tidy_parameters()`](https://larmarange.github.io/broom.helpers/dev/reference/tidy_parameters.md)
...
- New selecting functions
  ...
  [`all_contrasts()`](https://larmarange.github.io/broom.helpers/dev/reference/select_helpers.md),
  [`all_intercepts()`](https://larmarange.github.io/broom.helpers/dev/reference/select_helpers.md)
  and
...
- [`.clean_backticks()`](https://larmarange.github.io/broom.helpers/dev/reference/dot-clean_backticks.md)
  and
  [`.escape_regex()`](https://larmarange.github.io/broom.helpers/dev/reference/dot-escape_regex.md)
  are now exported
