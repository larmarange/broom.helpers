...
tibble::tribble(
  ...
  'n', '`tidy_add_n()`', 'Number of observations',
  'nevent', '`tidy_add_n()`', 'Number of events (for binomial and multinomial logistic models, Poisson and Cox models)',
  'n', '`tidy_add_n()`', 'Exposure time (for Poisson and Cox models)'
) %>%
    gt::gt() %>%
