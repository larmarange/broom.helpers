...
The tidier `tidy_marginal_contrasts()` allows to compute directly several combinations of variables and to stack all the results in a unique tibble. By default, they are determined with `model_list_higher_order_variables()`.
